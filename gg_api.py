...
def get_awards(year):
    ...
    if category == "tv_show":
        ...
        if sub_category == "best original song - motion picture":
        ...
        elif sub_category == "best motion picture - drama":
            people.append(sub_category)
        elif sub_category == "best television limited series, anthology series, or motion picture made for television":
            people.append(sub_category)
            ...
            people.append(sub_category)
        elif sub_category == "best director - motion picture":
            people.append(sub_category)
